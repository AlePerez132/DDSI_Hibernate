...
public class Monitor implements Serializable {
    ...
    public Monitor(String cm, String nom, String d, String t, String c, String f, String n){//Lo he puesto por mi cuenta
        this.codmonitor = cm;
        this.nombre = nom;
        this.telefono = t;
        this.dni = d;
    ...
    public void setActividadResponsable(Set<Actividad> actividadesResponsable) {
